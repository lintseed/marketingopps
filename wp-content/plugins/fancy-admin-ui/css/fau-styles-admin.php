...
table.solvease-rnc-table-head tfoot > tr > th, table.solvease-rnc-table-head thead > tr.main-table > th {
	background: #4a979e !important;
	border-color: <?php echo $fau_secondary; ?> !important;
	box-shadow: 1px 1px 0 #56afb8 inset !important;
}
