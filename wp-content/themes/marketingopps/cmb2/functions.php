 ...
 * @param  CMB2_Field object $field      Field object
 */
function opps_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'opps_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function opps_register_demo_metabox() {
	$prefix = 'opps_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'title'         => __( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'page', ), // Post type
		// 'show_on_cb' => 'opps_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		// 'show_names' => true, // Show field names on the left
		// 'cmb_styles' => false, // false to disable the CMB stylesheet
		...
		// 'classes_cb' => 'opps_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'opps_hide_if_no_cats', // function should return a bool value
		// 'sanitization_cb' => 'my_custom_sanitization', // custom sanitization callback parameter
		// 'escape_cb'       => 'my_custom_escaping',  // custom escaping callback parameter
		// 'on_front'        => false, // Optionally designate a field to wp-admin only
		// 'repeatable'      => true,
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'opps_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'opps_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'opps_before_row_if_2', // callback
...
add_action( 'cmb2_admin_init', 'opps_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function opps_register_about_page_metabox() {
	$prefix = 'opps_about_';
...
add_action( 'cmb2_admin_init', 'opps_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function opps_register_user_profile_metabox() {
	$prefix = 'opps_user_';
